        ...
        <div className="film-card__wrap">
          <div className="film-card__info">
            ...
            <div className="film-card__desc">
              <h2 className="film-card__title">{headerFilmTitle}</h2>
              <p className="film-card__meta">
                <span className="film-card__genre">{headerFilmGenre}</span>
                <span className="film-card__year">{headerFilmYear}</span>
              </p>
      ...
      <div className="page-content">
        <section className="catalog">
          ...
          <div className="catalog__films-list">
            {filmsList.map((film, index) => <FilmCard filmTitle={film} key={index.toString()} />)}
          </div>
